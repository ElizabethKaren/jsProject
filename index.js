document.addEventListener('DOMContentLoaded', function(){
    ...
    const myBlogs = `<div class="blog">
        ...
        <a href="https://elizabeth-michael-karen.medium.com/hash-tables-explained-c17481d9c98" target="_blank"><img src="./Images/hashTableImage.gif" width="560" height="315"></a>
        </div>
